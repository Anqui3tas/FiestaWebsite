...
This repo now deploys cleanly as a static site.
...
The included `wrangler.toml` already points Pages at the repository root, so no Worker or server-side signup endpoint is required.
